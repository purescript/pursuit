// Generated by psc version 0.6.7
var PS = PS || {};
PS.Prelude = (function () {
    "use strict";
...
PS.Data_Traversable = (function () {
    ...
    var traversableArray = new Traversable(function () {
        ...
        return function (_273) {
            ...
            if (_273.length >= 1) {
                var _330 = _273.slice(1);
                return Prelude["<*>"](__dict_Applicative_134["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_134["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_273[0]))(sequence(traversableArray)(__dict_Applicative_134)(_330));
            };
            throw new Error("Failed pattern match");
        };
        ...
        return function (_271) {
            return function (_272) {
                ...
                if (_272.length >= 1) {
                    var _334 = _272.slice(1);
                    return Prelude["<*>"](__dict_Applicative_133["__superclass_Prelude.Apply_0"]())(Prelude["<$>"]((__dict_Applicative_133["__superclass_Prelude.Apply_0"]())["__superclass_Prelude.Functor_0"]())(Prelude[":"])(_271(_272[0])))(traverse(traversableArray)(__dict_Applicative_133)(_271)(_334));
                };
                throw new Error("Failed pattern match");
            };
        };
...
PS.Thermite_Action = (function () {
    ...
    var runAction = function (ctx) {
        var go = function (_285) {
            if (_285 instanceof Pure) {
                return Prelude["return"](Control_Monad_Eff.monadEff)(Prelude.unit);
            };
            if (_285 instanceof Impure && _285.value0 instanceof GetState) {
                return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                    var _5 = Thermite_Internal.getStateImpl(ctx)();
                    return go(_285.value0.value0(_5))();
                });
            };
            if (_285 instanceof Impure && _285.value0 instanceof SetState) {
                return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                    Thermite_Internal.setStateImpl(ctx)(_285.value0.value0)();
                    return go(_285.value0.value1)();
                });
            };
            if (_285 instanceof Impure && _285.value0 instanceof Wait) {
                return _285.value0.value0(go);
            };
            throw new Error("Failed pattern match");
        };
        return go;
    ...
    var functorActionF = new Prelude.Functor(function (_283) {
        return function (_284) {
            if (_284 instanceof GetState) {
                return new GetState(Prelude["<<<"](Prelude.semigroupoidArr)(_283)(_284.value0));
            };
            if (_284 instanceof SetState) {
                return new SetState(_284.value0, _283(_284.value1));
            };
            if (_284 instanceof Wait) {
                return new Wait(function (k_1) {
                    return _284.value0(Prelude["<<<"](Prelude.semigroupoidArr)(k_1)(_283));
                });
            };
            throw new Error("Failed pattern match");
        };
    });
    var functorAction = new Prelude.Functor(function (_286) {
        return function (_287) {
            if (_287 instanceof Pure) {
                return new Pure(_286(_287.value0));
            };
            if (_287 instanceof Impure) {
                return new Impure(Prelude["<$>"](functorActionF)(Prelude["<$>"](functorAction)(_286))(_287.value0));
            };
            throw new Error("Failed pattern match");
        };
    });
    ...
    var bindAction = new Prelude.Bind(function (_288) {
        return function (_289) {
            if (_288 instanceof Pure) {
                return _289(_288.value0);
            };
            if (_288 instanceof Impure) {
                return Impure.create(Prelude["<#>"](functorActionF)(_288.value0)(function (a_1) {
                    return Prelude[">>="](bindAction)(a_1)(_289);
                }));
            };
            throw new Error("Failed pattern match");
        };
...
PS.Thermite = (function () {
    ...
    var componentWillMount = function (_290) {
        return function (_291) {
            var _362 = {};
            for (var _363 in _291) {
                if (_291.hasOwnProperty(_363)) {
                    _362[_363] = _291[_363];
                };
            };
            _362.componentWillMount = new Data_Maybe.Just(_290);
            return _362;
        };
    };
    return {
...
PS.Main = (function () {
    ...
    var Entry = (function () {
        function Entry(value0, value1, value2, value3) {
            this.value0 = value0;
            this.value1 = value1;
            this.value2 = value2;
            this.value3 = value3;
            ...
            return function (value1) {
                return function (value2) {
                    return function (value3) {
                        return new Entry(value0, value1, value2, value3);
                    };
                };
            };
        };
    ...
    var search = function (q) {
        ...
        return Prelude[">>="](Thermite_Action.bindAction)(Thermite_Action.async(Control_Monad_Eff_AJAX.get(uri)))(function (_9) {
            return Thermite_Action.setState({
                ...
                lastSearch: q, 
                results: (function () {
                    var _365 = Prelude[">>="](Data_Either.bindEither)(Data_Foreign.parseJSON(_9))(Data_Foreign_Class.read(Data_Foreign_Class.arrayIsForeign(isForeignEntry)));
                    if (_365 instanceof Data_Either.Left) {
                        return [  ];
                    };
                    if (_365 instanceof Data_Either.Right) {
                        return _365.value0;
                    };
                    throw new Error("Failed pattern match");
                })()
        ...
        return function (_293) {
            return function (_294) {
                ...
                var searchResults = (function () {
                    ...
                    if (Data_Array["null"](_293.results)) {
                        return Thermite_Html_Elements["p'"]([ Thermite_Html.text("No results for '" + (_293.lastSearch + "'")) ]);
                    };
                    if (Prelude.otherwise) {
                        return Thermite_Html_Elements["div'"](Prelude["<$>"](Data_Array.functorArray)(searchResult)(_293.results));
                    };
                    throw new Error("Failed pattern match");
                })();
                ...
                return container([ header([ Thermite_Html_Elements["h1'"]([ Thermite_Html.text("Pursuit") ]), Thermite_Html_Elements["div'"]([ Thermite_Html_Elements.input([ Thermite_Html_Attributes._type("search"), Thermite_Html_Attributes.className("form-control"), Thermite_Html_Attributes.placeholder("Search..."), Thermite_Events.onChange(_292)(handleChange), Thermite_Events.onBlur(_292)(handleBlur), Thermite_Events.onKeyUp(_292)(handleKey), Thermite_Html_Attributes.autoFocus(true), Thermite_Html_Attributes.value(_293.query) ])([  ]) ]) ]), body([ searchResults, Thermite_Html_Elements["div'"]([ Thermite_Html_Elements.a([ Thermite_Html_Attributes.href("http://github.com/purescript/pursuit") ])([ Thermite_Html.text("Source") ]), Thermite_Html.text(" | "), Thermite_Html_Elements.a([ Thermite_Html_Attributes.href("http://purescript.org") ])([ Thermite_Html.text("PureScript") ]) ]) ]) ]);
            };
        };
    };
    ...
    var performAction = function (_295) {
        return function (_296) {
            if (_296 instanceof Change) {
                return Thermite_Action.modifyState(function (o) {
                    var _383 = {};
                    for (var _384 in o) {
                        if (o.hasOwnProperty(_384)) {
                            _383[_384] = o[_384];
                        };
                    };
                    _383.query = _296.value0;
                    return _383;
                });
            };
            if (_296 instanceof Search && _296.value0 === "") {
                return Thermite_Action.setState({
                    query: "", 
                    lastSearch: "", 
                    results: [  ]
            ...
            if (_296 instanceof Search) {
                return Prelude[">>="](Thermite_Action.bindAction)(Thermite_Action.sync(updateHistorySearch(_296.value0)))(function () {
                    return search(_296.value0);
                });
            };
            if (_296 instanceof ReadQueryString) {
